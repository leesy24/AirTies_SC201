    ...
    */
    ...
    var constraintsMap = {
        ...
        Pattern: {
            ...
            //defaultMessage: '{label} ' + globalView.getMultiLanguageText('__ML_Regex_Msg') + '[ {format} ] ' + this.value + ' ' + globalView.getMultiLanguageText('__ML_Regex_wrong')
        ...
        if(typeof options != "undefined" && typeof options.elements != "undefined") {
            ...
            if(options.elements instanceof Array) {
                ...
                for(var i = 0; i < options.elements.length; i++) {
                    ...
                    /*
                    options.groups = options.elements[i].groups;
                    options.constraintType = options.elements[i].constraintType;
                    */
    ...
    function interpolateErrorMessage(elementId, elementConstraint, params) {
        ...
        if(/{userinput}/.test(errorMessage)) {
        	errorMessage = errorMessage.replace(/{userinput}/, element.value);
        }
