if(!__DEF_DefaultIpAddress)
{
	...
	if(!__DEF_DefaultIpAddress) var __DEF_DefaultIpAddress = "192.168.2.1";
}
if(!__DEF_UsbHostMaxConnectionLimit) var __DEF_UsbHostMaxConnectionLimit = "3";

if(!__DEF_airtouch_text) var __DEF_airtouch_text = "AirTouch";

var __ML_top_global_title = "Setup";
...
var __ML_ethernet_connection = "Ethernet:";
...
var __ML_dns_setup = "DNS Setup";
var __ML_mode_setup = "Mode Setup";
var __ML_ip_setup = "IP and DHCP Settings";
var __ML_lan_clients = "LAN Clients";
...
var __ML_wireless_mac_filtering = "MAC Filtering";
var __ML_firewall_mac_filtering = "MAC Filtering";
var __ML_mesh = "MESH";
...
var __ML_ddns = "DDNS";
var __ML_ddns_settings = "DDNS Settings";
...
var __ML_DDNS_setup = "DDNS Settings";
var __ML_DDNS_setup_intro = "You must get an account, password, and your static Domain Name from a DDNS service provider.<br>Choose one of the DDNS services supported by your device and enter the service information you will get from that service provider.";
var __ML_DDNS_user = "User name :";
var __ML_DDNS_pass = "Password :";
var __ML_DDNS_new_host = "You must get an account, password, and your static Domain Name from a DDNS service provider.<br>Choose one of the DDNS services supported by your device and enter the service information you will get from that service provider.";
...
var __ML_lan_dhcp_client_list = "LAN Client List";
...
var __ML_system_restart_text = "To restart your Wireless Connector select this option, connection to the device will be restored after a few seconds.";
var __ML_system_restart_text_2 = "To restart your Sky+ Link select this option, connection to the device will be restored after a few seconds.";
var __ML_restore_factory_defaults = "Restore Factory Defaults";
var __ML_restore_factory_defaults_text = "Select this option to reset your Wireless Connector back to its original settings.";
var __ML_restore_factory_defaults_text_2 = "Select this option to reset your Sky+ Link back to its original settings.";
var __ML_save_config_text = "You can save the current settings of your Wireless Connector using this option, if required these can be restored using the Restore Config option below.";
var __ML_save_config_text_2 = "You can save the current settings of your Sky+ Link using this option, if required these can be restored using the Restore Config option below.";
...
var __ML_FW_UPG_TXT = "To update the running firmware on the device, click the Browse button and locate the latest firmware from your local computer. Then click the Update button.";
var __ML_uiUpgrade = "Update";
...
var __ML_sntp_header = "Time Settings";
var __ML_sntp_info = "";
...
var __ML_report_intro = "";

var __ML_login_Copyright = "Copyright © 2005-2012 AirTies Wireless Networks. All rights reserved.";
...
var __ML_password_settings = "Change Password";
var __ML_password_intro = "";
var __ML_password_intro_mandatory = "You have to define a password to protect user interface. It is mandatory to change default password before login first time to user interface.";
...
var __ML_firewall_intro = "Firewall protects your computers and your network against harmful attacks from the Internet. Your device's firewall has Stateful Packet Inspection (SPI) feature that will inspect every packet coming from the Internet to your device and will not allow any that is not authorized to pass through. Using the Firewall menu, you can also define advanced rules to allow or prohibit local users in your network to access the Internet, to open certain ports that allow packets to reach applications running on local clients, and to forward all incoming traffic to a certain computer.";
...
//Firewall Mac Filter
var __ML_mac_filtering_feature = "The MAC Filtering feature blocks the computers to access the network according to their MAC addresses. When this feature is enabled, users  whose MAC addresses are listed, are blocked from device and Internet access. Enter a new MAC address and click Add or select from the existing clients listed.";
var __ML_mac_address_filtering = "MAC Address Filtering";
...
//NAT
var __ML_nat_caption = "NAT (Network Address Translation)";
...
var __ML_napt = "NAPT";
var __ML_protocol = "Protocol";
var __ML_org_source_ip_port = "Orginal Source IP:Port";
var __ML_org_dest_ip_port = "Orginal Dest. IP:Port";
var __ML_packets_bytes = "Packets / Bytes";
var __ML_replay_source_ip_port = "Replay Source IP:Port";
var __ML_replay_dest_ip_port = "Replay Dest. IP:Port";
...
var __ML_modem_can_be_configured = "Your device can be configured as a virtual server and clients on the Internet can access the services such as web or FTP servers on your LAN using real IP addresses that are forwarded to the local IP addresses of such servers. It can forward incoming packets to an IP address on the LAN based on the protocol and the port number. You can specify a port map using '-' character between two port numbers. Port Map example: 1060-1100";
...
//NAT - DMZ
var __ML_dmz_settings = "DMZ Settings";
...
//Management
var __ML_you_can_manage_modem = "You can manage your device using SNMP (Simple Network Management Protocol), telnet, or this web interface and also change you web interface password";

var __ML_you_can_manage_modem_without_snmp = "You can manage your device using this web interface and also change your web interface password.";
...
var __ML_ok = "OK";
var __ML_anti_dos_enabled = "Antidos Enabled";
var __ML_new_connections = "new connection";
var __ML_anti_dos_feature = "The Anti-DoS feature blocks Denial of Service attacks to your device. In this page, you can determine the maximum number of allowed connections for discrete protocols over a certain time.";
var __ML_tcp = "TCP";
var __ML_udp = "UDP";
var __ML_icmp = "ICMP";
...
var __ML_wireless_mesh_settings_intro = "AirTies Mesh overcomes signal strength and coverage limitations that may arise in large buildings. Mesh enables you to extend your coverage area with AirTies access point/repeater devices without any need for cables. To create a Mesh network, click the 'AP Search' button.";
...
var __ML_search_ap = "AP Search";
var __ML_searching_neighbouring_ap_please_wait = "Searching neighbouring Access Points<br />Please Wait";
...
var __ML_passphrase = "Passphrase";
...
var __ML_wireless_settings_wpa_description = "";
...
var __ML_wrong_sec_mode_channel = "AP security and channel settings are different from first SSID settings. These should be changed on wireless security page";

var __ML_wireless_security_no_encryption = "Wireless security is not required for the access point to operate and is WPA2 by default. Your device supports both encryption standards. WPA2 is the most secure protocol and is very hard to break. If some of the wireless clients in your wireless network do not support WPA2, then you should use the less secure WPA protocol.";
...
var __ML_ssid_active = "Active";
var __ML_ssid_passive = "Passive";
...
var __ML_wireless_network_enabled = "Wireless Network Active";
...
var __ML_upnp = "UPNP";
var __ML_upnp_settings = "UPNP Settings";
...
var __ML_upnp_intro = "Universal Plug&Play is a protocol that allows devices on the network to interoperate with each other automatically. To activate UPnP feature, devices on your network to be connected to UPnP interoperating system must support the UPnP protocol.";
...
var __ML_upnp_status_caption = "UPNP";
var __ML_upnp_settings_caption = "UPNP Settings";
...
var __ML_vlan1_caption = "On this page, you can adjust the settings of your device for its WAN connection over Ethernet. After entering the VLAN name and the protocol type, you can adust the settings of the chosen protocol.";
var __ML_internet_dns_intro = "On this page, you can adjust your device’s DNS settings. You can use the DNS IP addresses as assigned by your service provider or you can set these addresses according to  your preferences.";
...
var __ML_ssid = "SSID";
var __ML_mesh_wpa_warning = "An active mesh link cannot be set while WPA is enabled. Please modify the security settings prior to enabling a mesh link.";
var __ML_security_wpa_mesh_warning = "WPA cannot be selected when there is an active mesh link. Please disable active mesh links before enabling WPA.";
...
/* ############################# */
var __ML_lan_ip_dhcp_settings_caption = "IP and DHCP Settings";
...
var __ML_lan_ip_dhcp_settings_dhcp_server_name = "DHCP Name";
...
var __ML_wireless_wlan_password = "Password";
...
var __ML_usb_host_status_active_tooltip = "%diskid% is attached and active. Please click on the <i><b>EJECT</b></i> button before removing the media physically.";
var __ML_usb_host_status_inactive_tooltip = "%partitionid% on %diskid% is attached but inactive. Please click on <i><b>ACTIVATE</b></i> button in order to use this device.";
...
var __ML_usb_host_ex_description3 = "NOTE: If you have any problem for reaching your USB device, please ensure adding  “" + top.location.host + "” address to “Trusted sites” in your browser. ( In your browser, follow “Tools”->  “Internet options”-> “Security” -> “Trusted sites” -> “Sites”)";
...
var __ML_wireless_settings_radar_channel_warning = "The channel you would like to switch is a radar channel. Mesh and WPS do not work at radar channels. If you would like to switch to a radar channel, please first disable WPS and Mesh.";
...
var __ML_wireless_settings_intro = "";
var __ML_wireless_settings_intro2_freq_2400 = "";
var __ML_wireless_settings_intro2_freq_5000 = "";
var __ML_igmp_intro_for_TT = "IGMP v1, v2 and v3 protocols are supported.";
var __ML_3g_fo_button = "Connect to Internet using 3G";
var __ML_always_connect_via_3g_when_adsl_disconnects = "Always connect via 3G when DSL disconnects";
...
var __ML_redirect_to_modem = "<a href='/main.html'>Click here for device settings.</a>";
...
var __ML_wireless_certification_validation_msg1 = "WPS and WEP security type can not be used together. Disable WPS or choose a security type other than WEP.";
var __ML_wireless_certification_validation_msg2 = "WPS and WPA-Enterprise security type can not be used together. Disable WPS or choose security type as WPA-Personal at Wireless Security Settings page.";
var __ML_wireless_certification_validation_mode_security_msg = "You can not use @mode@ mode while you have @security@ security on your device. This security type is a weak security protocol and can be hacked easily. If you would like to choose 802.11n mode on your device, you need to change security type to WPA2 only.";
...
var __ML_wireless_certification_validation_msg6 = "WPS and WEP security type can not be used together. Disable WPS at Wireless Settings page or choose a security type other than WEP.";
var __ML_wireless_certification_validation_msg7 = "WPS and WPA-Enterprise security type can not be used together. Disable WPS at Wireless Settings page or choose security type as WPA-Personal.";
...
var __ML_wireless_certification_validation_msg11 = "WPS and WEP security type can not be used together. Disable WPS at Wireless Settings page or choose a security type other than WEP.";
var __ML_wireless_certification_validation_msg12 = "WPS and WPA-Enterprise security type can not be used together. Disable WPS at Wireless Settings page or choose security type as WPA-Personal at Wireless Security Settings page.";
...
var __ML_wireless_operating_mode_access_point_description = "<strong>Access Point –</strong> The device will function as a Wireless Access point and can be configured as part of a MESH network.";
var __ML_wireless_operating_mode_bridge_description = "<strong>Bridge –</strong> Device will bridge Ethernet port to selected Wireless Access Point. Note that Access Point operation on the device will be disabled when bridge mode is selected.";
...
var __ML_wireless_operating_mode_bridge_mode_warning = "You are about to connect this device to your existing Access Point. Note that the IP address of the device may also change."
var __ML_wireless_operating_mode_repeater_mode_warning = "You are about to connect this device to your existing Access Point. Note that the IP address of the device may also change."
...
var __ML_you_can_manage_modem_without_snmp_and_telnet = "You can change your web interface password.";

var __ML_WPS_PIN = "WPS PIN :";

var __ML_wireless_WPS = "Wi-Fi Protected Setup";
var __ML_wireless_WPS_info = "Devices can be easily added to the wireless network using Wi-Fi Protected Setup (WPS).";
...
var __ML_wireless_WPS_disabled_message = "WPS is currently disabled. It can be enabled on the Wireless Settings page.";
...
var __ML_wireless_WPS_warning_no_security = "Warning. You have disabled security and Wireless Protection Method is enabled. Your device can be accessed without any security credentials.";
...
var __ML_file_is_too_big = "File size is too big";
var __ML_file_is_too_small = "File size is too small";
var __ML_menu_licence_information = "Licence Information";

var __ML_sky_wireless_settings_wpa_password_error_message = "The password does not meet the necessary requirements. Please use letters and numbers and ensure your password is between 8 and 63 characters in length.";
...
var __ML_vpn_status_text = {"0": "Not connected", "1": "Connecting", "2": "Connected"};
var __ML_vpn_enabled_text = {"false": "Disabled", "true": "Enabled"};
